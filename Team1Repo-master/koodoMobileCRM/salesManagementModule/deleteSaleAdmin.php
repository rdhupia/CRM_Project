	...
	?>
		...
		<div class="col-md-10">
			...
			<h3>Approval Information</h3>
				<tr>
					<td class="col-md-2">Reason for Deletion: </td>
		...
		<div class="form-group">
			<div class="col-sm-offset-6 col-sm-6">
				<a class="btn btn-warning btn-lg" href="viewSalesAdmin.php" role="button">Go Back</a>	
				<a class="btn btn-danger btn-lg" href="viewSalesAdmin.php" role="button">Delete</a>	
			</div>
		</div>
