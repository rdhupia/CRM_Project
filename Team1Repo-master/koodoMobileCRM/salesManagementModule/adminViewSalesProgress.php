<?php
	...
	?>
		...
		<div class="main-content container ">
			...
			<div class="main-content container">
                <div class="row">
				    <h4>Set Progress for <?php print $month." ".$year;?></h4>
			    </div>
                    ...
                    <tbody>
                        ...
                        <?php 
                            ...
                            while( $row = mysqli_fetch_assoc($result) ) 
                            {
                                ...
                                $userSales = Sale::getSalesByUser($row['id'], $month, $year);
                        ...
                        <form class="form-horizontal" action = "<?php $_PHP_SELF ?>" method="POST">      
                            <tr>
                                <td class="col-md-1"><?php print $row['id']; ?></td>
                                <td class="col-md-2"><?php print $row['firstName']." ".$row['lastName']; ?></td>
                                <td class="col-md-2"><?php print $row['userName']; ?></td>
