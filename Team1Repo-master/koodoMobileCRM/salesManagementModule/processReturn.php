	...
	?>
		...
		<div class="col-md-10">
			...
			<table class="table   table-striped table-bordered">
				<tr>
					<td class="col-md-2">Reason for Return: </td>
					<td class="col-md-2" colspan="3"></td>
		...
		<div class="form-group">
			<div class="col-sm-offset-6 col-sm-6">
				<a class="btn btn-success btn-lg" href="../library/searchResult.php" role="button">Go Back</a>
				<a class="btn btn-warning btn-lg" href="../library/searchResult.php" role="button">Confirm Return</a>	
			</div>
		</div>
